"""
This script allows the user to filter the dataset.
Currently is supported only filter by allowed extensions list.

It accepts
    * path to a folder with input -- folder with projects
    * path to a folder for output
    * optional argument --extension-list with a list allowed file extensions
    (without this argument all files will be saved).
"""
